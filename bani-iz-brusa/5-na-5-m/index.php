    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="row">
		...
		<div class="row">
          ...
          <button class="button-style open-modal" data-toggle="callback" data-options="name,tel,email" data-text="Заказ бани из бруса 5 на 5 метра с террасой">Оставить заявку</button>
...
Баня 5х5м с террасой, комнатой отдыха, душевой и парилкой.
        </div>
     </div>

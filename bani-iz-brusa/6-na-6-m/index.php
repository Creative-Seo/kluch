...
'; ?>
<?php $title = 'Баня из бруса 6 на 6 метра с террасой под ключ во Владимире, проект, фото, цена'; ?>
<?php $description = 'Готовый проект бани из бруса 6 на 6 метра с террасой под ключ во Владимире по доступной цене, фото, планировка'; ?>
<?php $keywords = ''; ?>
<?php $breadcrumb2 = 'Бани из бруса'; ?>
<?php $breadcrumb2_url = 'http://www.kluch585.ru/bani-iz-brusa/'; ?>
<?php $breadcrumb = 'Баня из бруса 6x4 м'; ?>
<?php $canonical = 'http://www.kluch585.ru/bani-iz-brusa/6-na-6-m/'; ?>
<?php include("../../blocks/meta.php"); ?>
<?php include("../../blocks/header.php"); ?>
<?php include("../../blocks/breadcrumbs.php"); ?>
<div class="container proekt-style">
  <div class="row">
    <h1>Баня из бруса 6 на 6 метра с террасой</h1>
    <div class="col-lg-1 col-md-1 hidden-sm hidden-xs" style="padding:0"> 
    <div class="gallery">
    <a class="fancybox-thumb" rel="gallery1" href="http://www.kluch585.ru/bani-iz-brusa/6-na-6-m/banya-iz-brusa-6-na-6-m-1.jpg"><img src="http://www.kluch585.ru/bani-iz-brusa/6-na-6-m/banya-iz-brusa-6-na-6-m-1.jpg" width="150" class="img-responsive" alt="Баня из бруса 6 на 6 метра"/></a>
   </div>
    </div>
    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12"> 
    <a class="fancybox-thumb" rel="gallery1" href="http://www.kluch585.ru/bani-iz-brusa/6-na-6-m/banya-iz-brusa-6-na-6-m.jpg"><img src="http://www.kluch585.ru/bani-iz-brusa/6-na-6-m/banya-iz-brusa-6-na-6-m.jpg" class="img-responsive" alt="Баня из бруса 6 на 6 метра"/></a>
    <!--gallery-->  
        ...
        <div class="opisanie table-responsive">
           <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row">Площадь террасы:</th>
                  <td>4х1,2 м</td>
                </tr>
              </tbody>
           </table>  
...
Баня 6х6 с террасой, тамбуром, комнатой отдыха, душевой и парилкой.
        </div>
     </div>
     ...
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 hidden-xs">
        ...
        <div class="gallery2">
    <a class="fancybox-thumb2" rel="gallery1" href="http://www.kluch585.ru/bani-iz-brusa/6-na-6-m/banya-iz-brusa-6-na-6-m-planirovka.jpg"><img src="http://www.kluch585.ru/bani-iz-brusa/6-na-6-m/banya-iz-brusa-6-na-6-m-planirovka.jpg" width="150" class="img-responsive" alt="Планировка Баня из бруса 6 на 6 метра"/></a>
   </div>

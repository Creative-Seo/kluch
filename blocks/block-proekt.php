...
<?php if ($akciya) {echo '<img src="http://www.kluch585.ru/dachnyie-domiki/img/akciya.png" width="100px" alt="" style="position:absolute; top:0;right:0">';$akciya=false;}?>
  ...
  <div class="arrow_box6 asf"> <span class="proekt-name" itemprop="name"><?php echo $name; ?></span> <span class="price-proekt" itemtype="http://schema.org/Offer" itemprop="offers" itemscope><?php echo $cena_ot; ?><span class="red-text" itemprop="price"><?php echo $price; ?></span>

...
<div class="nav-color">    
    <div class="container">
      <div class="row">
<div class="cd-main-header"> <a class="cd-logo hidden-lg hidden-md hidden-sm" href="#0">Ключ 585<!--<img src="/img/logo.png" alt="Logo">--></a>
    ...
    <li><a href="/besedki/">Беседки</a></li>
     ...
     <li class="has-children"> <a href="javascript:void(0);">Пиломатериалы</a>
        ...
        <li class="go-back"><a href="#0">Назад</a></li>
              ...
              <li><a href="/derevyannyy-pogonazh/">Погонаж оптом</a></li>
